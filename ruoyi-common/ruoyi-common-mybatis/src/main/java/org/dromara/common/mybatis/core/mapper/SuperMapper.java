...
public interface SuperMapper<T, V> extends MPJBaseMapper<T> {
    ...
    default Class<V> currentVoClass() {
        return (Class<V>) GenericTypeUtils.resolveTypeArguments(this.getClass(), SuperMapper.class)[1];
    }
    ...
    default Class<T> currentModelClass() {
        return (Class<T>) GenericTypeUtils.resolveTypeArguments(this.getClass(), SuperMapper.class)[0];
    }
