...
public interface GenConstants {
     ...
     * 数据库字符串类型
     */
    String[] COLUMNTYPE_STR = {"char", "varchar", "set", "nchar", "nvarchar", "varchar2", "nvarchar2"};
    ...
    String[] COLUMNNAME_NOT_ADD = {"create_dept", "create_by", "create_time", "del_flag", "update_by",
        "update_time", "version", "tenant_id", "deleted"};
    ...
    String[] COLUMNNAME_NOT_QUERY = {"id", "create_dept", "create_by", "create_time", "del_flag", "update_by",
        "update_time", "remark", "version", "tenant_id", "deleted"};

    /**
     * Entity基类字段
     */
    String[] BASE_ENTITY = {"createDept", "createBy", "createTime", "updateBy", "updateTime", "tenantId", "deleted"};
