...
public class VelocityUtils {
     ...
     * 基础字段
     */
    public static final Set<String> BASE_FIELDS = new HashSet<>();

    static {
        Arrays.stream(ReflectUtil.getFields(BaseEntity.class)).forEach(field -> BASE_FIELDS.add(field.getName()));
        BASE_FIELDS.add("tenantId");
    }
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("baseDOFields", BASE_FIELDS);
...
//        templates.add("vm/ts/types.ts.vm");
        if (GenConstants.TPL_CRUD.equals(tplCategory)) {
            ...
            templates.add("vm/vben/data.ts.vm");
            templates.add("vm/vben/edit-form.vue.vm");
            templates.add("vm/vben/index.vue.vm");
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        if (template.contains("mapper.java.vm")) {
            ...
            fileName = StringUtils.format("{}/views/{}/{}/index.vue", vuePath, moduleName, businessName);
        }else if (template.contains("edit-form.vue.vm")){
            fileName = StringUtils.format("{}/views/{}/{}/edit-form.vue", vbenPath, moduleName, businessName);
        }else if (template.contains("vben/index.vue.vm")){
